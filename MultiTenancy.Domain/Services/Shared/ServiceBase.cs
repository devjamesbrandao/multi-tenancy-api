...
using MultiTenancy.Domain.Interfaces.Services.Shared;

namespace MultiTenancy.Domain.Services.Shared;
...
public abstract class ServiceBase<TEntity> : IServiceBase<TEntity> where TEntity : Entity
{
    ...
    public virtual async Task<object> AddAsync(TEntity objeto) => await _repositoryBase.AddAsync(objeto);
